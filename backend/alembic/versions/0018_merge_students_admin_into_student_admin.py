"""merge students admin role into student admin
...
revision = "0018"
down_revision = "0017_add_program_audience"
branch_labels = None
depends_on = None
...
def upgrade():
    _rename_role("students_admin", "student_admin")


def downgrade():
    _rename_role("student_admin", "students_admin")
